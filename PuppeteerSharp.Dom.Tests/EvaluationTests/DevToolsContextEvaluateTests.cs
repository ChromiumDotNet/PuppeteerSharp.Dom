...
namespace PuppeteerSharp.Dom.Tests.DevToolsContextTests
{
    ...
    public class DevToolsContextEvaluateTests : PuppeteerPageBaseTest
    {
        ...
        [PuppeteerDomFact(Skip = "Crashes WebView2")]
        ...
        [PuppeteerDomFact(Skip = "Unable to get meaningful error https://github.com/MicrosoftEdge/WebView2Feedback/issues/1609")]
